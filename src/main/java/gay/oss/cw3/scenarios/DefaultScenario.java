...
public class DefaultScenario extends Scenario {
    ...
    public void init() throws Exception {
        ...
        this.registerEntity(EntityLayer.ANIMALS, "Snake", new Vector3f(1, 1, 0), Snake.class, 0.005f, false, true, null);
        ...
        if (this.isOpenGL) {
            ...
            renderer.autoLoadModel(Snake.class, "snake.png", "snake", 0.03f, RenderMode.UseLOD);
